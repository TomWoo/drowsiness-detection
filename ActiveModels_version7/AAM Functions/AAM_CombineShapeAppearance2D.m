function ShapeAppearanceData=AAM_CombineShapeAppearance2D(TrainingData,ShapeData,AppearanceData,options)
...
Ws = AAM_Weights2D(TrainingData,ShapeData,AppearanceData,options);
